...
function decimalToHex2ByteLittleEndian(decimal) {
  if (decimal.includes(".")) decimal = parseFloat(decimal) * 100;else decimal = parseInt(decimal) * 100;

  if (decimal >= 0 && decimal <= 4294967295) {
    // Ensure decimal is within 4-byte range
    var hex = decimal.toString(16).padStart(4, "0").toUpperCase();
    var hexBytes = [hex.substr(0, 2), hex.substr(2, 2), hex.substr(4, 2), hex.substr(6, 2)];
...
function decimalToHex2ByteBigEndian(decimal) {
  if (decimal.includes(".")) decimal = parseFloat(decimal) * 10;else decimal = parseInt(decimal) * 10;
...
document.getElementById("connectToBoardID").addEventListener("click", function () {
  ...
  my_dongle.at_cancelconnect().then(function (x) {
    ...
    my_dongle.at_dual().then(function (y) {
      ...
      console.log(theID);
      my_dongle.at_findscandata("5B070614" + theID, 3).then(function (z) {
        console.log(z);
        ...
        if (lastVal.includes("[")) {
          ...
          my_dongle.at_gapconnect("[0]" + macAddress).then(function (res) {
            if (res[2] == "CONNECTED.") {
              document.getElementById("terminal").innerHTML += res + "<br/>";
              my_dongle.at_spssend2("P=477432     ").then(function (res2) {
                console.log(res2);
          ...
          console.log("CANNOT FIND TO MATRIX. Please make sure the Matrix is advertising or the ID is correct then try again.");
        } //console.log(lastVal);
...
var readBtn = function readBtn(msgID, btnName) {
  ...
  my_dongle.at_spssend("AREV=" + msgID).then(function (x) {
    setTimeout(function () {
      my_dongle.at_spssend("AREV=" + msgID).then(function (y) {
        setTimeout(function () {
          my_dongle.at_spssend("AREV=" + msgID).then(function (z) {
            setTimeout(function () {
              console.log(z);
...
var confBtnLittleEndian = function confBtnLittleEndian(writeID, readID, btnName) {
  var theVal = document.getElementById(btnName + "_VALUE").value;
...
var confBtnDec2BigEndian = function confBtnDec2BigEndian(writeID, readID, btnName) {
  var theVal = document.getElementById(btnName + "_VALUE").value;
...
var confBtnDec2Hex = function confBtnDec2Hex(writeID, readID, btnName, size) {
  var theVal = document.getElementById(btnName + "_VALUE").value;
...
document.getElementById("BOARDID_READ_BTN").addEventListener("click", function () {
  readBtn("0 ", "BOARDID");
});
document.getElementById("BOARDID_CONF_BTN").addEventListener("click", function () {
  confBtn("0", "0 ", "BOARDID");
}); //PRODUCTID id

document.getElementById("PRODUCTID_READ_BTN").addEventListener("click", function () {
  readBtn("1 ", "PRODUCTID");
});
document.getElementById("PRODUCTID_CONF_BTN").addEventListener("click", function () {
  confBtn("1", "1 ", "PRODUCTID");
}); //SERIAL NUMBER

document.getElementById("SERIAL_NUMBER_READ_BTN").addEventListener("click", function () {
  readBtn("2 ", "SERIAL_NUMBER");
});
document.getElementById("SERIAL_NUMBER_CONF_BTN").addEventListener("click", function () {
  confBtn("2", "2 ", "SERIAL_NUMBER");
}); //FIRMWARE_REV

document.getElementById("FIRMWARE_REV_READ_BTN").addEventListener("click", function () {
  readBtn("3 ", "FIRMWARE_REV");
});
document.getElementById("FIRMWARE_REV_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("3", "3 ", "FIRMWARE_REV");
}); //ARTICLE_NUMBER

document.getElementById("ARTICLE_NUMBER_READ_BTN").addEventListener("click", function () {
  readBtn("4 ", "ARTICLE_NUMBER");
});
document.getElementById("ARTICLE_NUMBER_CONF_BTN").addEventListener("click", function () {
  confBtn("4", "4 ", "ARTICLE_NUMBER");
}); //K_FACTOR

document.getElementById("K_FACTOR_READ_BTN").addEventListener("click", function () {
  readBtn("5 ", "K_FACTOR");
});
document.getElementById("K_FACTOR_CONF_BTN").addEventListener("click", function () {
  confBtnDec2BigEndian("5", "5 ", "K_FACTOR");
}); //FACTORY_RESET

document.getElementById("FACTORY_RESET_READ_BTN").addEventListener("click", function () {
  readBtn("6 ", "FACTORY_RESET");
});
document.getElementById("FACTORY_RESET_CONF_BTN").addEventListener("click", function () {
  confBtn("6", "6 ", "FACTORY_RESET");
}); //ACTUAL_POS

document.getElementById("ACTUAL_POS_READ_BTN").addEventListener("click", function () {
  readBtn("7 ", "ACTUAL_POS");
});
document.getElementById("ACTUAL_POS_CONF_BTN").addEventListener("click", function () {
  confBtnDec2Hex("7", "7 ", "ACTUAL_POS", 4);
}); //RESET_COUNTER

document.getElementById("RESET_COUNTER_READ_BTN").addEventListener("click", function () {
  readBtn("8 ", "RESET_COUNTER");
});
document.getElementById("RESET_COUNTER_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("8", "8 ", "RESET_COUNTER");
}); //FLOOR_TH

document.getElementById("FLOOR_TH_READ_BTN").addEventListener("click", function () {
  readBtn("9 ", "FLOOR_TH");
});
...
document.getElementById("MAX_STEP_POS_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("11", "11 ", "MAX_STEP_POS");
}); //V_MAX

document.getElementById("V_MAX_READ_BTN").addEventListener("click", function () {
  readBtn("12 ", "V_MAX");
});
...
document.getElementById("I_RUN_CONF_BTN").addEventListener("click", function () {
  confBtnDec2Hex("13", "13 ", "I_RUN", 1);
}); //TIME_MIN_TO_MAX

document.getElementById("TIME_MIN_TO_MAX_READ_BTN").addEventListener("click", function () {
  readBtn("14 ", "TIME_MIN_TO_MAX");
});
document.getElementById("TIME_MIN_TO_MAX_CONF_BTN").addEventListener("click", function () {
  confBtnDec2Hex("14", "14 ", "TIME_MIN_TO_MAX", 1);
}); //TIME_MAX_TO_MIN

document.getElementById("TIME_MAX_TO_MIN_READ_BTN").addEventListener("click", function () {
  readBtn("15 ", "TIME_MAX_TO_MIN");
});
document.getElementById("TIME_MAX_TO_MIN_CONF_BTN").addEventListener("click", function () {
  confBtnDec2Hex("15", "15 ", "TIME_MAX_TO_MIN", 1);
}); //FACTORY_SET_DATE

document.getElementById("FACTORY_SET_DATE_READ_BTN").addEventListener("click", function () {
  readBtn("16 ", "FACTORY_SET_DATE");
});
document.getElementById("FACTORY_SET_DATE_CONF_BTN").addEventListener("click", function () {
  confBtn("16", "16 ", "FACTORY_SET_DATE");
}); //LAST_CONFIG

document.getElementById("LAST_CONFIG_READ_BTN").addEventListener("click", function () {
  readBtn("17 ", "LAST_CONFIG");
});
document.getElementById("LAST_CONFIG_CONF_BTN").addEventListener("click", function () {
  confBtnLittleEndian("17", "17 ", "LAST_CONFIG");
}); //PROJECT_NUMBER

document.getElementById("PROJECT_NUMBER_READ_BTN").addEventListener("click", function () {
  readBtn("18 ", "PROJECT_NUMBER");
});
document.getElementById("PROJECT_NUMBER_CONF_BTN").addEventListener("click", function () {
  confBtnLittleEndian("18", "18 ", "PROJECT_NUMBER");
}); //LAST_CALIBRATION

document.getElementById("LAST_CALIBRATION_READ_BTN").addEventListener("click", function () {
  readBtn("19 ", "LAST_CALIBRATION");
});
document.getElementById("LAST_CALIBRATION_CONF_BTN").addEventListener("click", function () {
  confBtnLittleEndian("19", "19 ", "LAST_CALIBRATION");
}); //NUM_MATRIX_PLATES

document.getElementById("NUM_MATRIX_PLATES_READ_BTN").addEventListener("click", function () {
  readBtn("20 ", "NUM_MATRIX_PLATES");
});
document.getElementById("NUM_MATRIX_PLATES_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("20", "20 ", "NUM_MATRIX_PLATES");
}); //ERROR_MESSAGE

document.getElementById("ERROR_MESSAGE_READ_BTN").addEventListener("click", function () {
  readBtn("21 ", "ERROR_MESSAGE");
});
document.getElementById("ERROR_MESSAGE_CONF_BTN").addEventListener("click", function () {
  confBtnLittleEndian("21", "21 ", "ERROR_MESSAGE");
}); //MASTER_SLAVE_ROLE

document.getElementById("MASTER_SLAVE_ROLE_READ_BTN").addEventListener("click", function () {
  readBtn("22 ", "MASTER_SLAVE_ROLE");
});
document.getElementById("MASTER_SLAVE_ROLE_CONF_BTN").addEventListener("click", function () {
  confBtn("22", "22 ", "MASTER_SLAVE_ROLE");
}); //INTERNAL_EXTERNAL

document.getElementById("INTERNAL_EXTERNAL_READ_BTN").addEventListener("click", function () {
  readBtn("23 ", "INTERNAL_EXTERNAL");
});
document.getElementById("INTERNAL_EXTERNAL_CONF_BTN").addEventListener("click", function () {
  confBtnLittleEndian("23", "23 ", "INTERNAL_EXTERNAL");
}); //ACT_FLOW

document.getElementById("ACT_FLOW_READ_BTN").addEventListener("click", function () {
  readBtn("24 ", "ACT_FLOW");
});
document.getElementById("ACT_FLOW_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("24", "24 ", "ACT_FLOW");
}); //PRESSURE

document.getElementById("PRESSURE_READ_BTN").addEventListener("click", function () {
  readBtn("25 ", "PRESSURE");
});
document.getElementById("PRESSURE_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("25", "25 ", "PRESSURE");
}); //SLAVE_MAC_ADDR1

document.getElementById("SLAVE_MAC_ADDR1_READ_BTN").addEventListener("click", function () {
  readBtn("26 ", "SLAVE_MAC_ADDR1");
});
document.getElementById("SLAVE_MAC_ADDR1_CONF_BTN").addEventListener("click", function () {
  confBtn("26", "26 ", "SLAVE_MAC_ADDR1");
}); //SLAVE_MAC_ADDR2

document.getElementById("SLAVE_MAC_ADDR2_READ_BTN").addEventListener("click", function () {
  readBtn("27 ", "SLAVE_MAC_ADDR2");
});
document.getElementById("SLAVE_MAC_ADDR2_CONF_BTN").addEventListener("click", function () {
  confBtn("27", "27 ", "SLAVE_MAC_ADDR2");
}); //SLAVE_MAC_ADDR3

document.getElementById("SLAVE_MAC_ADDR3_READ_BTN").addEventListener("click", function () {
  readBtn("28 ", "SLAVE_MAC_ADDR3");
});
document.getElementById("SLAVE_MAC_ADDR3_CONF_BTN").addEventListener("click", function () {
  confBtn("28", "28 ", "SLAVE_MAC_ADDR3");
}); //SLAVE_MAC_ADDR4

document.getElementById("SLAVE_MAC_ADDR4_READ_BTN").addEventListener("click", function () {
  readBtn("29 ", "SLAVE_MAC_ADDR4");
});
document.getElementById("SLAVE_MAC_ADDR4_CONF_BTN").addEventListener("click", function () {
  confBtn("29", "29 ", "SLAVE_MAC_ADDR4");
}); //SLAVE_MAC_ADDR5

document.getElementById("SLAVE_MAC_ADDR5_READ_BTN").addEventListener("click", function () {
  readBtn("30 ", "SLAVE_MAC_ADDR5");
});
document.getElementById("SLAVE_MAC_ADDR5_CONF_BTN").addEventListener("click", function () {
  confBtn("30", "30 ", "SLAVE_MAC_ADDR5");
}); //SLAVE_MAC_ADDR6

document.getElementById("SLAVE_MAC_ADDR6_READ_BTN").addEventListener("click", function () {
  readBtn("31 ", "SLAVE_MAC_ADDR6");
});
document.getElementById("SLAVE_MAC_ADDR6_CONF_BTN").addEventListener("click", function () {
  confBtn("31", "31 ", "SLAVE_MAC_ADDR6");
}); //SLAVE_MAC_ADDR7

document.getElementById("SLAVE_MAC_ADDR7_READ_BTN").addEventListener("click", function () {
  readBtn("32 ", "SLAVE_MAC_ADDR7");
});
document.getElementById("SLAVE_MAC_ADDR7_CONF_BTN").addEventListener("click", function () {
  confBtn("32", "32 ", "SLAVE_MAC_ADDR7");
}); //MASTER_NUM_SLAVE_CONN

document.getElementById("MASTER_NUM_SLAVE_CONN_READ_BTN").addEventListener("click", function () {
  readBtn("33 ", "MASTER_NUM_SLAVE_CONN");
});
document.getElementById("MASTER_NUM_SLAVE_CONN_CONF_BTN").addEventListener("click", function () {
  confBtnDec2Hex("33", "33 ", "MASTER_NUM_SLAVE_CONN", 1);
}); //SLAVE_BOARDID_1

document.getElementById("SLAVE_BOARDID_1_READ_BTN").addEventListener("click", function () {
  readBtn("34 ", "SLAVE_BOARDID_1");
});
document.getElementById("SLAVE_BOARDID_1_CONF_BTN").addEventListener("click", function () {
  confBtn("34", "34 ", "SLAVE_BOARDID_1");
}); //SLAVE_BOARDID_2

document.getElementById("SLAVE_BOARDID_2_READ_BTN").addEventListener("click", function () {
  readBtn("35 ", "SLAVE_BOARDID_2");
});
document.getElementById("SLAVE_BOARDID_2_CONF_BTN").addEventListener("click", function () {
  confBtn("35", "35 ", "SLAVE_BOARDID_2");
}); //SLAVE_BOARDID_3

document.getElementById("SLAVE_BOARDID_3_READ_BTN").addEventListener("click", function () {
  readBtn("36 ", "SLAVE_BOARDID_3");
});
document.getElementById("SLAVE_BOARDID_3_CONF_BTN").addEventListener("click", function () {
  confBtn("36", "36 ", "SLAVE_BOARDID_3");
}); //SLAVE_BOARDID_4

document.getElementById("SLAVE_BOARDID_4_READ_BTN").addEventListener("click", function () {
  readBtn("37 ", "SLAVE_BOARDID_4");
});
document.getElementById("SLAVE_BOARDID_4_CONF_BTN").addEventListener("click", function () {
  confBtn("37", "37 ", "SLAVE_BOARDID_4");
}); //SLAVE_BOARDID_5

document.getElementById("SLAVE_BOARDID_5_READ_BTN").addEventListener("click", function () {
  readBtn("38 ", "SLAVE_BOARDID_5");
});
document.getElementById("SLAVE_BOARDID_5_CONF_BTN").addEventListener("click", function () {
  confBtn("38", "38 ", "SLAVE_BOARDID_5");
}); //SLAVE_BOARDID_6

document.getElementById("SLAVE_BOARDID_6_READ_BTN").addEventListener("click", function () {
  readBtn("39 ", "SLAVE_BOARDID_6");
});
document.getElementById("SLAVE_BOARDID_6_CONF_BTN").addEventListener("click", function () {
  confBtn("39", "39 ", "SLAVE_BOARDID_6");
}); //HAS_SENSOR

document.getElementById("HAS_SENSOR_READ_BTN").addEventListener("click", function () {
  readBtn("50 ", "HAS_SENSOR");
});
document.getElementById("HAS_SENSOR_CONF_BTN").addEventListener("click", function () {
  confBtn("50", "50 ", "HAS_SENSOR");
}); //HAS_MODEM

document.getElementById("HAS_MODEM_READ_BTN").addEventListener("click", function () {
  readBtn("51 ", "HAS_MODEM");
});
document.getElementById("HAS_MODEM_CONF_BTN").addEventListener("click", function () {
  confBtn("51", "51 ", "HAS_MODEM");
}); //MIN_FLOW

document.getElementById("MIN_FLOW_READ_BTN").addEventListener("click", function () {
  readBtn("52 ", "MIN_FLOW");
});
document.getElementById("MIN_FLOW_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("52", "52 ", "MIN_FLOW");
}); //REQ_FLOW

document.getElementById("REQ_FLOW_READ_BTN").addEventListener("click", function () {
  readBtn("53 ", "REQ_FLOW");
});
document.getElementById("REQ_FLOW_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("53", "53 ", "REQ_FLOW");
}); //TOL_FLOW

document.getElementById("TOL_FLOW_READ_BTN").addEventListener("click", function () {
  readBtn("54 ", "TOL_FLOW");
});
document.getElementById("TOL_FLOW_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("54", "54 ", "TOL_FLOW");
}); //SIGNAL

document.getElementById("SIGNAL_READ_BTN").addEventListener("click", function () {
  readBtn("55 ", "SIGNAL");
});
document.getElementById("SIGNAL_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("55", "55 ", "SIGNAL");
}); //O_PRESSURE

document.getElementById("O_PRESSURE_READ_BTN").addEventListener("click", function () {
  readBtn("56 ", "O_PRESSURE");
});
document.getElementById("O_PRESSURE_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("56", "56 ", "O_PRESSURE");
}); //K_VALUE

document.getElementById("K_VALUE_READ_BTN").addEventListener("click", function () {
  readBtn("57 ", "K_VALUE");
});
document.getElementById("K_VALUE_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("57", "57 ", "K_VALUE");
}); //CONTROL_TYPE

document.getElementById("CONTROL_TYPE_READ_BTN").addEventListener("click", function () {
  readBtn("58 ", "CONTROL_TYPE");
});
document.getElementById("CONTROL_TYPE_CONF_BTN").addEventListener("click", function () {
  confBtn("58", "58 ", "CONTROL_TYPE");
}); //MAX_FLOW

document.getElementById("MAX_FLOW_READ_BTN").addEventListener("click", function () {
  readBtn("59 ", "MAX_FLOW");
});
document.getElementById("MAX_FLOW_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("59", "59 ", "MAX_FLOW");
}); //DAC_OUT_MIN_FLOW

document.getElementById("DAC_OUT_MIN_FLOW_READ_BTN").addEventListener("click", function () {
  readBtn("60 ", "DAC_OUT_MIN_FLOW");
});
document.getElementById("DAC_OUT_MIN_FLOW_CONF_BTN").addEventListener("click", function () {
  confBtnDec2("60", "60 ", "DAC_OUT_MIN_FLOW");
}); //DAC_OUT_MAX_FLOW

document.getElementById("DAC_OUT_MAX_FLOW_READ_BTN").addEventListener("click", function () {
  readBtn("61 ", "DAC_OUT_MAX_FLOW");
});
document.getElementById("DAC_OUT_MAX_FLOW_CONF_BTN").addEventListener("click", function () {
